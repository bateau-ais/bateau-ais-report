...
Voir le Tableau @tbl:mise_en_oeuvre:topics-flux.
...
Voir le Tableau @tbl:mise_en_oeuvre:seuils-decisionnels.
...
: Topics et flux de données {#tbl:mise_en_oeuvre:topics-flux}
...
: Seuils décisionnels sourcés {#tbl:mise_en_oeuvre:seuils-decisionnels}
